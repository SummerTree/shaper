...
Split_1 = model.addSplit(Part_1_doc, [model.selection("SOLID", "Compound_2_1_1_1"), model.selection("SOLID", "Compound_2_1_2_3")], [model.selection("COMPOUND", "Compound_3_1_2")])
...
model.testNbResults(Split_1, 2)
model.testNbSubResults(Split_1, [5, 7])
model.testNbSubShapes(Split_1, GeomAPI_Shape.SOLID, [5, 7])
model.testNbSubShapes(Split_1, GeomAPI_Shape.FACE, [37, 56])
model.testNbSubShapes(Split_1, GeomAPI_Shape.EDGE, [148, 250])
model.testNbSubShapes(Split_1, GeomAPI_Shape.VERTEX, [296, 500])
model.testResultsVolumes(Split_1, [6283.185307174889203452, 10109.63121762967239192])
