...
model.testNbSubShapes(Split_1, GeomAPI_Shape.SOLID, [14])
model.testNbSubShapes(Split_1, GeomAPI_Shape.FACE, [102])
model.testNbSubShapes(Split_1, GeomAPI_Shape.EDGE, [428])
model.testNbSubShapes(Split_1, GeomAPI_Shape.VERTEX, [856])
model.testResultsVolumes(Split_1, [25476.0018319841583434])
